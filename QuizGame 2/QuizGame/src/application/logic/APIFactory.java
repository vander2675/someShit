...
public class APIFactory implements IAPIFactory {
	...
	@Override
	public IPlayer makePlayer(int number, String name, Image image, Color color) { return makePlayerImpl(number, name, image, color); }
	...
	private IPlayer makePlayerImpl(int number, String name, Image image, Color color)  {
